...
namespace kinectModality
{
    public class SwipeUpGesture
    {
        ...
        {
            SwipeUpSegment swipe_up_segment = new SwipeUpSegment();
            _gesture_segments = new GestureSegment_Int1[] { swipe_up_segment, swipe_up_segment, swipe_up_segment, swipe_up_segment, swipe_up_segment, swipe_up_segment };
        }
