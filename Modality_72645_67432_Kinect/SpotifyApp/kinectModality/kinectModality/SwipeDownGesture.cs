...
namespace kinectModality
{
    public class SwipeDownGesture
    {
        ...
        public SwipeDownGesture()
        {
            SwipeDownSegment swipe_down_segment = new SwipeDownSegment();
            _gesture_segments = new GestureSegment_Int1[] { swipe_down_segment, swipe_down_segment, swipe_down_segment, swipe_down_segment, swipe_down_segment, swipe_down_segment };
        }
