...
namespace kinectModality
{
    public class CloseEarsGesture
    {
        ...
        public CloseEarsGesture()
        {
            CloseEarsSegment close_ears_segment = new CloseEarsSegment();
            _gesture_segments = new GestureSegment_Int1[] { close_ears_segment, close_ears_segment, close_ears_segment, close_ears_segment, close_ears_segment, close_ears_segment };
        }
